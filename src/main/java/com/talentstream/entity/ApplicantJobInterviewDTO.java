...
public class ApplicantJobInterviewDTO {
	...
	public ApplicantJobInterviewDTO(String name, String email, String mobilenumber, String jobTitle, LocalDateTime timeAndDate,
			String location, String modeOfInterview, int round, String interviewLink, String interviewPerson) {
		super();
		this.name = name;
		this.email = email;
		this.mobilenumber = mobilenumber;
